<template>
  ...
  >
    <div class="shell relative flex flex-col gap-10 pb-20 pt-12 lg:min-h-[620px] lg:flex-row lg:items-center lg:gap-8 lg:pb-24 lg:pt-20">
      <!-- Text -->
      <div class="relative z-10 max-w-xl lg:w-[54%]">
        <p class="eyebrow text-gold-light">
          Table &amp; Seating Rentals · The DMV
        </p>
        <h1
          id="hero-heading"
        ...
        <p class="mt-8 inline-flex items-center gap-2 rounded-full border border-gold-light/35 bg-obsidian/60 px-3.5 py-1.5 text-[11px] font-medium text-gold-light">
      ...
      <div class="lg:w-[46%]">
        <div class="hero-stage relative mx-auto aspect-[4/5] w-full max-w-[380px] lg:mx-0 lg:aspect-auto lg:h-[520px] lg:w-full lg:max-w-none">
